...
values
  ...
  (8, 'DeepDesert_1', 0, '{"box":{"max_x":1,"max_y":1,"min_x":0,"min_y":0},"type":"box2d_array"}'::jsonb, '01 Recommended PVE Casual'),
  (31, 'DeepDesert_1', 1, '{"box":{"max_x":1,"max_y":1,"min_x":0,"min_y":0},"type":"box2d_array"}'::jsonb, '02 PVE Hardcore')
