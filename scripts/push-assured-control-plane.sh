...
for support in \
  ...
  admin/creator_canary.py admin/public_ip_canary.py admin/canary_autopilot.py admin/operations_briefing.py admin/operations_calendar.py admin/alert_inbox.py admin/peer_watch.py admin/player_life_recovery.py admin/addon_admin.py admin/base_creator.py admin/base_retirement.py admin/cosmetics_admin.py admin/gameplay_presets.py \
