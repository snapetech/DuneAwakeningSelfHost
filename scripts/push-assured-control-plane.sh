...
usage() {
  cat <<'EOF'
Usage: scripts/push-assured-control-plane.sh --manifest FILE --reason TEXT [--host HOST] [--required-host HOSTNAME] [--remote-workspace DIR] [--remote-env FILE]
