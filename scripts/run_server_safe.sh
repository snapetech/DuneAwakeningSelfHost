...
main() {
  ...
  load_workspace_value DUNE_BUILDING_PIECE_LIMIT
  load_workspace_bool DUNE_BUILDING_PIECE_LIMIT_UE4SS_APPLY
  ...
  load_workspace_bool DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_PROBE
  load_workspace_value DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_MAX
  ...
  load_workspace_bool DUNE_PROBE_LOADER_UE_FNAME_ALLOW_MISSING_NONE
  ...
  load_workspace_bool DUNE_PROBE_LOADER_LUA_REFLECTION_RAW_SET_ENABLED
  ...
  load_workspace_value DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND
  load_workspace_value DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND_ADDRESS
  load_workspace_value DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OUTPUT_ADDRESS
  load_workspace_value DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_EXECUTOR_ADDRESS
  load_workspace_bool DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_FORCE_CALL
  ...
  load_workspace_value DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_FUNCTION_ADDRESS
  load_workspace_value DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_FUNCTION_PATH
  load_workspace_value DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_PARAMS_ADDRESS
  ...
  load_workspace_value DUNE_PROBE_LOADER_LUA_MOD_ROOT
  load_workspace_bool DUNE_PROBE_LOADER_LUA_MOD_DISPATCH_SELF_TEST
  load_workspace_value DUNE_IGW_BIND_ADDRESS
  ...
  elif [ -n "${DUNE_IGW_BIND_ADDRESS:-}" ]; then
    args+=("-IGWBindAddress=${DUNE_IGW_BIND_ADDRESS}")
  fi
    ...
    if [ -n "${DUNE_RUN_SERVER_SAFE_ENV_OUT:-}" ]; then
      {
        ...
        printf 'DUNE_BUILDING_PIECE_LIMIT=%s\n' "${DUNE_BUILDING_PIECE_LIMIT:-}"
        printf 'DUNE_BUILDING_PIECE_LIMIT_UE4SS_APPLY=%s\n' "${DUNE_BUILDING_PIECE_LIMIT_UE4SS_APPLY:-}"
        ...
        printf 'DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_PROBE=%s\n' "${DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_PROBE:-}"
        printf 'DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_MAX=%s\n' "${DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_MAX:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_VTABLE_SCAN=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_VTABLE_SCAN:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_VTABLE_SCAN_SLOTS=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_VTABLE_SCAN_SLOTS:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_VTABLE_SCAN_MAX_OBJECTS=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_VTABLE_SCAN_MAX_OBJECTS:-}"
        ...
        printf 'DUNE_PROBE_LOADER_UE_FNAME_ALLOW_MISSING_NONE=%s\n' "${DUNE_PROBE_LOADER_UE_FNAME_ALLOW_MISSING_NONE:-}"
        ...
        printf 'DUNE_PROBE_LOADER_LUA_REFLECTION_RAW_SET_ENABLED=%s\n' "${DUNE_PROBE_LOADER_LUA_REFLECTION_RAW_SET_ENABLED:-}"
        ...
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_HOOK_IMAGE_OFFSET=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_HOOK_IMAGE_OFFSET:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_IMAGE_OFFSET=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_IMAGE_OFFSET:-}"
        ...
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_HOOK_IMAGE_OFFSET=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_HOOK_IMAGE_OFFSET:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_IMAGE_OFFSET=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_IMAGE_OFFSET:-}"
        ...
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_LIVE_HOOK_IMAGE_OFFSET=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_LIVE_HOOK_IMAGE_OFFSET:-}"
        ...
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_ALLOW_NATIVE_CALL=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_ALLOW_NATIVE_CALL:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_THROUGH_TARGET=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_THROUGH_TARGET:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OBJECT_ADDRESS=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OBJECT_ADDRESS:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND_ADDRESS=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND_ADDRESS:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OUTPUT_ADDRESS=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OUTPUT_ADDRESS:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_EXECUTOR_ADDRESS=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_EXECUTOR_ADDRESS:-}"
        printf 'DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_FORCE_CALL=%s\n' "${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_FORCE_CALL:-}"
        ...
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_LIVE_HOOK_IMAGE_OFFSET=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_LIVE_HOOK_IMAGE_OFFSET:-}"
        ...
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_ALLOW_NATIVE_CALL=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_ALLOW_NATIVE_CALL:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_THROUGH_TARGET=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_THROUGH_TARGET:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_SUPPRESS_ORIGINAL=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_SUPPRESS_ORIGINAL:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_OBJECT_ADDRESS=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_OBJECT_ADDRESS:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_FUNCTION_ADDRESS=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_FUNCTION_ADDRESS:-}"
        printf 'DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_PARAMS_ADDRESS=%s\n' "${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_PARAMS_ADDRESS:-}"
        ...
        printf 'DUNE_PROBE_LOADER_LUA_MOD_ROOT=%s\n' "${DUNE_PROBE_LOADER_LUA_MOD_ROOT:-}"
  ...
  if [ "${DUNE_ENABLE_LINUX_SERVER_PRELOAD:-false}" = "true" ]; then
    exec runuser -u dune -- env \
      ...
      "DUNE_BUILDING_PIECE_LIMIT=${DUNE_BUILDING_PIECE_LIMIT:-}" \
      "DUNE_BUILDING_PIECE_LIMIT_UE4SS_APPLY=${DUNE_BUILDING_PIECE_LIMIT_UE4SS_APPLY:-}" \
      ...
      "DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_PROBE=${DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_PROBE:-}" \
      "DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_MAX=${DUNE_PROBE_LOADER_UE_OBJECT_ARRAY_CLASS_REFLECTION_MAX:-}" \
      ...
      "DUNE_PROBE_LOADER_UE_FNAME_ALLOW_MISSING_NONE=${DUNE_PROBE_LOADER_UE_FNAME_ALLOW_MISSING_NONE:-}" \
      ...
      "DUNE_PROBE_LOADER_LUA_REFLECTION_RAW_SET_ENABLED=${DUNE_PROBE_LOADER_LUA_REFLECTION_RAW_SET_ENABLED:-}" \
      ...
      "DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_ALLOW_NATIVE_CALL=${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_ALLOW_NATIVE_CALL:-}" \
      ...
      "DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OBJECT_ADDRESS=${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OBJECT_ADDRESS:-}" \
      "DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND=${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND:-}" \
      "DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND_ADDRESS=${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_COMMAND_ADDRESS:-}" \
      "DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OUTPUT_ADDRESS=${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_OUTPUT_ADDRESS:-}" \
      "DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_EXECUTOR_ADDRESS=${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_EXECUTOR_ADDRESS:-}" \
      "DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_FORCE_CALL=${DUNE_PROBE_LOADER_UE_CALL_FUNCTION_ACTIVE_VALIDATE_FORCE_CALL:-}" \
      ...
      "DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_OBJECT_ADDRESS=${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_OBJECT_ADDRESS:-}" \
      ...
      "DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_FUNCTION_ADDRESS=${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_FUNCTION_ADDRESS:-}" \
      ...
      "DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_PARAMS_ADDRESS=${DUNE_PROBE_LOADER_UE_PROCESS_EVENT_ACTIVE_VALIDATE_PARAMS_ADDRESS:-}" \
      ...
      "DUNE_PROBE_LOADER_LUA_MOD_ROOT=${DUNE_PROBE_LOADER_LUA_MOD_ROOT:-}" \
...
load_workspace_bool() {
  ...
  value="$(workspace_env_value "$name")"
  [ -n "$value" ] || return 0
  if [ -n "${!name:-}" ] && ! workspace_env_overrides_runtime "$name"; then
    return 0
  fi
  case "$value" in
    true|false)
...
workspace_env_overrides_runtime() {
  case "$1" in
    DUNE_ENABLE_LINUX_SERVER_PRELOAD|DUNE_LINUX_SERVER_PRELOAD|DUNE_LINUX_SERVER_PRELOAD_PARTITIONS|DUNE_PROBE_LOADER_*)
      return 0
      ;;
  esac
  return 1
...
resolve_server_pak() {
  local server_root="$1"
  local configured="${2:-}"
  local paks_dir="$server_root/DuneSandbox/Content/Paks"
  local candidate
  ...
  for candidate in \
    "$paks_dir/pakchunk0-LinuxServer.pak" \
    "$paks_dir/DuneSandbox-LinuxServer.pak"
  do
    if [ -f "$candidate" ]; then
      printf '%s\n' "$candidate"
      return 0
...
install_brt_dd_buildable_map_region_pak_patch() {
  ...
  local pak
  pak="$(resolve_server_pak "$server_root" "${DUNE_BRT_DD_BUILDABLE_MAP_REGION_PAK:-}")"
...
install_landsraad_vendor_faction_gate_patch() {
  ...
  local pak
  pak="$(resolve_server_pak "$server_root" "${DUNE_LANDSRAAD_VENDOR_FACTION_GATE_PAK:-}")"
  local oodle
  oodle="$(resolve_oodle_library "${DUNE_OODLE_LIBRARY:-/tmp/oodle/liboodle-data-shared.so}")"
