...
COMMANDS = [
    ...
    {"name": "RemoveSessionMember", "tier": "player", "status": "gated-preview", "syntax": "RemoveSessionMember <player>", "chat": "&disconnect <player>", "notes": "Preferred targeted disconnect candidate after native payload verification."},
    {"name": "KickLobbyMember", "tier": "player", "status": "gated-preview", "syntax": "KickLobbyMember <player>", "chat": "&gm dry KickLobbyMember <player>", "notes": "Fallback targeted disconnect candidate."},
