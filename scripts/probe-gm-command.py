...
def main():
    ...
    parser.add_argument("--target-player", default="TestPlayer", help="Target/admin player name for candidate envelopes.")
    parser.add_argument("--admin-player", default="TestPlayer", help="Admin player name for candidate envelopes.")
