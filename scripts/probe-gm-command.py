...
def main():
    ...
    parser.add_argument("--target-player", default="SamplePlayer", help="Target/admin player name for candidate envelopes.")
    parser.add_argument("--admin-player", default="SamplePlayer", help="Admin player name for candidate envelopes.")
