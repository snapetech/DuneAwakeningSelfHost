...
Defaults:
  ...
  DUNE_HARDCORE_DD_EXPECTED_LABEL=02 PVE Hardcore
...
expected_label="$(env_or_file_any "02 PVE Hardcore" DUNE_HARDCORE_DD_EXPECTED_LABEL DUNE_PVP_DD_EXPECTED_LABEL)"
