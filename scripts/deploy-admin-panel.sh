...
python3 -m py_compile admin/admin_panel.py admin/cosmetics_admin.py admin/restore_drill.py admin/operational_slo.py admin/capacity_intelligence.py scripts/backup-restore-drill.py scripts/operational-slo.py scripts/capacity-intelligence.py scripts/build-cosmetic-catalog.py scripts/admin-chat-commands.py scripts/player-presence-announcer.py
