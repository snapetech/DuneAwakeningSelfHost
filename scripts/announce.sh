...
sender_name = env("DUNE_ANNOUNCE_CHAT_SPOOF_NAME", "Paul")
...
platform_id = env("DUNE_ANNOUNCE_CHAT_PLATFORM_ID", "PAUL")
platform_name = env("DUNE_ANNOUNCE_CHAT_PLATFORM_NAME", "Paul")
