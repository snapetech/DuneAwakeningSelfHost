...
- [`scripts/install-artificial-exchange-service.sh`](scripts/install-artificial-exchange-service.sh): systemd installer for the always-on artificial Exchange buyer and populator services.
