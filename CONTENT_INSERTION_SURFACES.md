...
| Database state | Journey, recipe, vehicle, and raw table mutation research. | Existing database observations without safe function contracts. | low | high | unknown | Map safe DB functions or live examples first. | Blocked in v1. |
