...
ENV_KEY_DEFINITIONS.update({
    ...
    "DUNE_ARTIFICIAL_EXCHANGE_MAX_BUY_PRICE_TOLERANCE_PCT": {"group": "Artificial Exchange", "secret": False, "restart": True, "why": "Percent above catalog max_buy_price that the buyer may still accept."},
    ...
    "DUNE_ARTIFICIAL_EXCHANGE_PURCHASE_NOTIFY_ENABLED": {"group": "Artificial Exchange", "secret": False, "restart": True, "why": "Sends a private whisper to the seller after an artificial buyer purchase."},
    "DUNE_ARTIFICIAL_EXCHANGE_PURCHASE_NOTIFY_TEMPLATE": {"group": "Artificial Exchange", "secret": False, "restart": True, "why": "Private seller message template after an artificial buyer purchase."},
    "DUNE_ARTIFICIAL_EXCHANGE_PURCHASE_NOTIFY_EXCHANGE": {"group": "Artificial Exchange", "secret": False, "restart": True, "why": "Whisper exchange used for artificial buyer seller notices."},
    "DUNE_ARTIFICIAL_EXCHANGE_PURCHASE_NOTIFY_CHANNEL": {"group": "Artificial Exchange", "secret": False, "restart": True, "why": "Chat channel type used for artificial buyer seller notices."},
    "DUNE_ARTIFICIAL_EXCHANGE_PURCHASE_NOTIFY_ROUTING_KEY": {"group": "Artificial Exchange", "secret": False, "restart": True, "why": "Optional override for seller notice whisper routing key; blank uses seller FLS id."},
