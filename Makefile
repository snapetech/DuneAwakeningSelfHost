...
validate: test-public-ip-canary test-canary-autopilot test-operations-briefing test-operations-calendar test-alert-inbox test-restore-alert-inbox test-peer-watch test-release-packaging test-vendored-release-tools
