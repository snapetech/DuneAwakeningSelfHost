...
.PHONY: install-target-safety-audit-timer loader-build-toolchain-check loader-build-toolchain-install verify-loader-artifacts test-verify-loader-artifacts test-community-rewards community-rewards-check test-moderation moderation-check test-base-creator test-gameplay-presets test-command-console test-federated-auth test-backup-encryption test-cosmetics-admin test-install-release test-panel-command test-ha-packaging test-deployment-packaging
...
test-windows-client-loader-package:
	...
	bash -n scripts/package-windows-client-loader.sh scripts/package-linux-client-loader.sh scripts/package-linux-server-loader.sh
