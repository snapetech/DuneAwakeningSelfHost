...
- Server-side 31-partition warm-pool registration is proven when status reports `current_alive_active=31 active_servers=31 partitions=31` with `COMPOSE_FILES='compose.yaml:compose.allmaps.yaml'`.
