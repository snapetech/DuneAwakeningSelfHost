...
| `m_BaseBackupToolMapRestriction` | `((Name="HaggaBasin"), (Name="Survival_1"), (Name="DeepDesert"), (Name="DeepDesert_1"), (Name="Editor_Default"), (Name="IGW_Test_Small"))` | 1 | Inferred / validate | BRT map allow-list candidate. Shipped/default evidence excluded Deep Desert, matching the "base backup not allowed in this region" symptom better than the landclaim segment limit alone. |
